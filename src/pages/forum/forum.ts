...
export class ForumPage {
	...
	constructor(public http:Http, public navCtrl: NavController,private alertCtrl: AlertController, private modalCtrl: ModalController, public GenericProvider: GenericProvider,) { 
